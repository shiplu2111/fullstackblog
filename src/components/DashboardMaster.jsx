  ...
  return (
    <>
                  ...
                  >
                    ...
                    <ul className="py-1" role="none">
                      ...
                      <li>
                        <div
                          onClick={logOut}
                          className="hover:cursor-pointer block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                          role="menuitem"
                        >
                          Sign out
                        </div>
      ...
      <aside
        id="logo-sidebar"
        className={`${
          sidebarOpen ? "" : "transition-transform -translate-x-full"
